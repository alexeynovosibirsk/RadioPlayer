...
public class GainControl implements net.sourceforge.jaad.aac.gain.GCConstants {

	private final int frameLen, lbLong, lbShort;
	private final net.sourceforge.jaad.aac.gain.IMDCT imdct;
	private final net.sourceforge.jaad.aac.gain.IPQF ipqf;
	...
	public GainControl(int frameLen) {
		...
		lbShort = lbLong/8;
		imdct = new net.sourceforge.jaad.aac.gain.IMDCT(frameLen);
		ipqf = new net.sourceforge.jaad.aac.gain.IPQF();
		levelPrev = new int[0][][];
