...
public class ICStream implements Constants, HCB, ScaleFactorTable, net.sourceforge.jaad.aac.syntax.IQTable {
	...
	//always needed
	private final net.sourceforge.jaad.aac.syntax.ICSInfo info;
	...
	public ICStream(int frameLength) {
		...
		info = new net.sourceforge.jaad.aac.syntax.ICSInfo(frameLength);
