...
public class FilterBank implements Constants, SineWindows, KBDWindows {
	...
	private final net.sourceforge.jaad.aac.filterbank.MDCT mdctShort, mdctLong;
	...
	public FilterBank(boolean smallFrames, int channels) throws AACException {
		...
		mdctShort = new net.sourceforge.jaad.aac.filterbank.MDCT(shortLen*2);
		mdctLong = new net.sourceforge.jaad.aac.filterbank.MDCT(length*2);
