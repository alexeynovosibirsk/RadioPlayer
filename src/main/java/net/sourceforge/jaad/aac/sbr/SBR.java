...
public class SBR implements Constants, net.sourceforge.jaad.aac.syntax.Constants, HuffmanTables {
	...
	int calc_sbr_tables(int start_freq, int stop_freq,
		...
		this.k0 = net.sourceforge.jaad.aac.sbr.FBT.qmf_start_channel(start_freq, samplerate_mode, this.sample_rate);
		k2 = net.sourceforge.jaad.aac.sbr.FBT.qmf_stop_channel(stop_freq, this.sample_rate, this.k0);
		...
		if(freq_scale==0) {
			result += net.sourceforge.jaad.aac.sbr.FBT.master_frequency_table_fs0(this, this.k0, k2, alter_scale);
		}
		else {
			result += net.sourceforge.jaad.aac.sbr.FBT.master_frequency_table(this, this.k0, k2, freq_scale, alter_scale);
		}
