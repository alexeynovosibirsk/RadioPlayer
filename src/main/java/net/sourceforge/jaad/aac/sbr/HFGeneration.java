...
class HFGeneration {
	...
	public static void hf_generation(net.sourceforge.jaad.aac.sbr.SBR sbr, float[][][] Xlow,
                                     float[][][] Xhigh, int ch) {
		int l, i, x;
	...
	private static void auto_correlation(net.sourceforge.jaad.aac.sbr.SBR sbr, acorr_coef ac, float[][][] buffer,
                                         int bd, int len) {
	...
	private static void calc_prediction_coef(net.sourceforge.jaad.aac.sbr.SBR sbr, float[][][] Xlow,
	...
	/* FIXED POINT: bwArray = COEF */
	private static void calc_chirp_factors(net.sourceforge.jaad.aac.sbr.SBR sbr, int ch) {
		int i;
