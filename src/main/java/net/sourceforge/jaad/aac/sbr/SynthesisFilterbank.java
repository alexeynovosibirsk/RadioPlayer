...
class SynthesisFilterbank implements net.sourceforge.jaad.aac.sbr.FilterbankTable {
	...
	void sbr_qmf_synthesis_32(net.sourceforge.jaad.aac.sbr.SBR sbr, float[][][] X,
                              float[] output) {
