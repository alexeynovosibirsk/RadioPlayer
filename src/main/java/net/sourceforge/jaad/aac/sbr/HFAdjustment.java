...
class HFAdjustment implements net.sourceforge.jaad.aac.sbr.Constants, net.sourceforge.jaad.aac.sbr.NoiseTable {
	...
	public static int hf_adjustment(net.sourceforge.jaad.aac.sbr.SBR sbr, float[][][] Xsbr, int ch) {
	...
	private static int get_S_mapped(net.sourceforge.jaad.aac.sbr.SBR sbr, int ch, int l, int current_band) {
	...
	private static int estimate_current_envelope(net.sourceforge.jaad.aac.sbr.SBR sbr, HFAdjustment adj,
                                                 float[][][] Xsbr, int ch) {
	...
	private static void hf_assembly(net.sourceforge.jaad.aac.sbr.SBR sbr, HFAdjustment adj,
                                    float[][][] Xsbr, int ch) {
